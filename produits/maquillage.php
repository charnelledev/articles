...
<body class="bg-pink-50 text-gray-800 font-sans">
    <div class="min-h-screen px-4 py-10">
        <div class="max-w-5xl mx-auto bg-white p-8 rounded-2xl shadow-lg">
            ...
            <p class="text-center mb-10">Découvrez nos produits coups de cœur pour sublimer votre beauté au quotidien 💋</p>

            <!-- Galerie -->
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                <div class="bg-pink-100 rounded-xl p-4 shadow-md">
                    <img src="https://via.placeholder.com/300x200.png?text=Rouge+à+Lèvres" class="rounded-lg mb-3" alt="Rouge à lèvres">
                ...
                <div class="bg-pink-100 rounded-xl p-4 shadow-md">
                    <img src="https://via.placeholder.com/300x200.png?text=Palette+Yeux" class="rounded-lg mb-3" alt="Palette yeux">
                    <h2 class="text-lg font-semibold">Palette Yeux</h2>
                    <button class="mt-2 bg-pink-500 text-white px-4 py-2 rounded-lg hover:bg-pink-600">Voir</button>
                </div>

                <div class="bg-pink-100 rounded-xl p-4 shadow-md">
                    <img src="https://via.placeholder.com/300x200.png?text=Fond+de+Teint" class="rounded-lg mb-3" alt="Fond de teint">
