  ...
  <div class="container mx-auto px-4">
    <div class="flex justify-between items-center py-4">
      ...
      <div class="hidden md:flex space-x-6">
        ...
        <a href="#" class="text-gray-800 hover:text-blue-600">À propos</a>
        ...
        <a href="#" class="text-gray-800 hover:text-blue-600">Nouveautés</a>
        <a href="#" class="text-gray-800 hover:text-blue-600">Promotions</a>
        <a href="#" class="text-gray-800 hover:text-blue-600">Conseils &amp; Tutoriels</a>
        <a href="#" class="text-gray-800 hover:text-blue-600">Contact</a>
      </div>

      <!--  Mon Compte / Panier -->
      <div class="hidden md:flex space-x-4">
        <a href="#" class="text-gray-800 hover:text-blue-600">Mon Compte</a>
        <a href="#" class="text-gray-800 hover:text-blue-600">Panier</a>
      </div>
  ...
  <section id="produits" class="py-16 bg-white">
    <div class="container mx-auto px-4">
      ...
      <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-gray-100 p-6 rounded-lg shadow">
          <img src="https://i.pinimg.com/736x/e7/47/8b/e7478b2b186ad96baeedc1d97dc24ed2.jpg/300x200" alt="Produit 3" class="w-full rounded">
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-white p-6 rounded-lg shadow">
          <img src="https://via.placeholder.com/300x200" alt="Promotion 1" class="w-full rounded">
        ...
        <div class="bg-white p-6 rounded-lg shadow">
          <img src="https://via.placeholder.com/300x200" alt="Promotion 2" class="w-full rounded">
        ...
        <div class="bg-white p-6 rounded-lg shadow">
          <img src="https://via.placeholder.com/300x200" alt="Promotion 3" class="w-full rounded">
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="flex bg-gray-100 rounded-lg shadow overflow-hidden">
          <img src="https://via.placeholder.com/150" alt="Conseil 1" class="w-1/3 object-cover">
          <div class="p-4">
        ...
        <div class="flex bg-gray-100 rounded-lg shadow overflow-hidden">
          <img src="https://via.placeholder.com/150" alt="Conseil 2" class="w-1/3 object-cover">
          <div class="p-4">
